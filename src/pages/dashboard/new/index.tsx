...
const schema = z.object({
    ...
    city: z.string().nonempty("A cidade do carro é obrigatório"),
    whatsapp: z.string().min(10, "O telefone é obrigatório").refine((value) => /^(\d{11,12})$/.test(value), {
        message: "Número de telefone inválido."
    }),
    description: z.string().nonempty("A descricao do carro é obrigatório"),
})
        ...
        try {
            ...
            addDoc(collection(db, "cars"), {
                ...
                .catch(errors => {
                    ...
                    console.log("Erro ao cadastrar", errors)
                })
